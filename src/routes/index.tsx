        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              We are a team of real estate experts and programmers specializing in transforming your property
              search into a fast and smart experience, using the latest <em>artificial intelligence technologies</em>.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: Store, title: "Commercial Properties", desc: "Innovative spaces for shops, offices, and businesses." },
            ].map((t) => (
              <Link
                key={t.title}
                to="/property-types"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: FileCheck, title: "Legal Verification", desc: "Ensure all property documents and ownership titles are clear and legally sound." },
            ].map((t) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { n: 3, icon: CalendarCheck, title: "Schedule a Tour", desc: "Book a physical or virtual tour with our experts." },
              { n: 4, icon: Handshake, title: "Close the Deal", desc: "Get full legal support to complete your purchase safely." },
            ].map((s) => (
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="rounded-3xl bg-brand-gradient p-12 md:p-16 text-center shadow-elegant">
          ...
          <p className="text-white/85 text-lg mb-8 max-w-2xl mx-auto">
            Get a free consultation from our experts to help you find or invest in your dream property.
          </p>
